 ...
 */
fun Row.toPostgresColumn(): PostgresColumn = PostgresColumn(
 ...
 */
fun Row.toPostgresIndex(): PostgresIndex = PostgresIndex(
 ...
 */
fun Row.toPostgresFunction(): PostgresFunction = PostgresFunction(
 ...
 */
fun Row.toPostgresProcedure(): PostgresProcedure = PostgresProcedure(
    schema = string("schema"),
 ...
 */
fun Row.toPostgresSequence(): PostgresSequence = PostgresSequence(
